...
class App extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="App">
        <p><b>Warning: This is a prototype and not yet approved for clinical use. Until we have completed implementation of full server-side encryption and implemented a process for regular security audits, please do not submit sensitive data here.</b></p>
